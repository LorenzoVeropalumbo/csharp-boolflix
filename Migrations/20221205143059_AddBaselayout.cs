...
{
    /// <inheritdoc />
    public partial class AddBaselayout : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberEpisode = table.Column<int>(name: "Number_Episode", type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SingleEpisode = table.Column<int>(name: "Single_Episode", type: "int", nullable: false),
                    Duration = table.Column<double>(type: "float", nullable: false),
                    Remainingtime = table.Column<double>(name: "Remaining_time", type: "float", nullable: false),
